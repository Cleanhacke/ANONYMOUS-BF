...
significant_words = [
    # Marques de voitures
    "Tesla", "Ferrari", "Lamborghini", "Toyota", "Ford", "Chevrolet", "Mercedes", "BMW", "Audi", "Porsche", "Toyota", "Volkswagen", "Ford", "Honda", "Chevrolet", "Nissan", "Hyundai", "Kia", "Subaru", "Mercedes-Benz", "BMW", "Audi", "Lexus", "Tesla", "Mazda", "Land Rover", "Jeep", "Dodge", "Peugeot", "Renault", "Citroën", "Fiat", "Volvo", "Mitsubishi", "Acura", "Infiniti", "GMC", "Cadillac", "Buick", "Tata Motors", "Skoda", "Seat", "Suzuki", "Lincoln", "Chrysler", "Ram", "Aston Martin", "Ferrari", "Lamborghini", "Porsche", "Bentley", "Rolls-Royce", "Maserati", "Bugatti", "McLaren", "Pagani", "Alfa Romeo"
    ...
    "Python", "Java", "Laptop", "Server", "Router", "Firewall", "Crypto", "AI", "Cloud", "Python", "Java", "JavaScript", "C++", "C#", "Ruby", "PHP", "Swift", "Kotlin", "HTML", "CSS", "SQL", "React", "Angular", "Vue.js", "Node.js", "Django", "Flask", "REST", "API", "Git", "Docker", "Kubernetes", "Machine Learning", "Deep Learning", "Big Data", "Blockchain", "Cloud Computing", "Cybersecurity", "Virtualization", "HTML5", "CSS3", "jQuery", "TypeScript", "GraphQL", "Firebase", "Ruby on Rails", "Symfony", "Laravel", "WordPress", "Magento", "Shopify", "Xamarin", "Unity", "Game Development", "DevOps", "Agile", "Scrum",
